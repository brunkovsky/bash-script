...
echo "                                                                       Бланк АПП" > file_app
echo "                              Погода по аеродромам" >> file_app
echo $date1 $H12:$M12 >> file_app
echo "" >> file_app
echo "SA Фактична погода по аеродрому:" >> file_app
cat file_met >> file_app
echo "" >> file_app
echo "SP Штормова погода по аеродрому:" >> file_app
cat file_spe >> file_app
echo "" >> file_app
echo "FC Прогноз погоди по аеродрому:" >> file_app
