...
wget -O rawfile --user=userName --password=userPassword "http://*********.***.**/******/*****/blanks.phtml?T1=UKOH&blank=zipfile&nabors=&numb=1&srok=$date1+$H12%3A$M12%3A$S12&dosrok=$date2+$H12%3A$M12%3A$S12&SA=on&SP=off&FC=off&FT=off"
